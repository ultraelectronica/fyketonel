...
const timelineItems: TimelineItem[] = [
  ...
  },
  {
    ...
    type: "quest",
    status: "success",
    description: "LockerApp v1 shipped—vault wards sealed and live.",
    week: 2,
  },
  {
    id: "exp-flick",
    title: "Flick Audio Furnace",
    type: "experiment",
    status: "ongoing",
    description: "Tuning Rust-powered audio pipeline and Flutter UX loops.",
    week: 3,
    intensity: "warp",
  },
  {
  ...
  {
    id: "quest-revo-notion",
    title: "Revo vs Notion Feature Skirmish",
    type: "quest",
    status: "ongoing",
    description: "Upgrading Revo&apos;s workspace flows to stand toe-to-toe with Notion.",
    week: 5,
  },
  {
    id: "quest-ci-fix",
